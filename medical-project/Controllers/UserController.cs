...
namespace medical_project.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<AppUserDto>>> GetUsers()
        {
            ...
            return Ok(CustomResponse.CustResponse("Users has been fetched successfully", true, users));
        }
        [HttpGet("{id}")]
        public async Task<ActionResult<AppUserDto>> GetUser(int id)
        {
            var result = await _userRepo.GetUserByIdAsync(id);
            return Ok(CustomResponse.CustResponse("User has been fetched successfully", true, result));
        }
        [HttpGet("my-details")]
        [Authorize]
        public async Task<ActionResult<AppUserDto>> GetDetails()
        {
            ...
            return Ok(CustomResponse.CustResponse("Your details has been fetched succesfully.", true, result));
        }
    }
}
